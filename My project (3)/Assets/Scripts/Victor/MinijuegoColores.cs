...
public class ColorSelector : MonoBehaviour
{
    ...
    private List<int> correctIndexes = new List<int> { 1, 2, 5, 6 }; // Ajusta estos �ndices a los correctos
    ...
    void CheckResult()
    {
        ...
        {
            resultText.text = "Vaya combinaci�n de mierda hermano, da igual el mensaje, con estos colores no llegamos a ning�n lado";
